...
public class BCHTransctionUtil {

    private static final String TAG = "BCHTransctionUtil";

    private Gson gson = new GsonBuilder()
            .disableHtmlEscaping() 
            .create();
    private Context mContext;
    private BchApi mApi = new BchApi();
    private WalletDBUtil walletDBUtil;
    private TransferBean mBean;
    private WalletTransctionUtil.BchTransctionListen mListen;

    public BCHTransctionUtil(Context context, WalletTransctionUtil.BchTransctionListen mListen) {
    ...
    public void getBCHestimateFee(TransferBean transferBean) {
        if (null != mListen) {
            mListen.showLoading();
        }
        Map<String, Object> params = new TreeMap<>();
        mApi.getBCHestimateFee(new Gson().toJson(params)).observeOn(AndroidSchedulers.mainThread())
    ...
    public void getBchTxId(TransferBean transferBean, String xpubAddr, String pwd) {
        ...
        mApi.getBchTxId(transferBean.getPayaddress()).observeOn(AndroidSchedulers.mainThread())
    ...
    public void trans(TransferBean transferBean, List<BchTxIdBean> txid, String pwd) {
        ...
        ThreadManager.getNormalPool().execute(new Runnable() {
            ...
            public void run() {
                ...
                CoinType coinBtc = CoinType.BITCOINCASH;
