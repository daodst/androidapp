...
public class TitleBarView extends RelativeLayout {
    ...
    public void setRightTextOnclick(boolean pd) {
        if (pd) {
            ...
            tvTitlerights.setTextColor(getResources().getColor(R.color.default_titlebar_right_color));
        } else {
    ...
    private void init(Context context, TypedArray ta) {
        ...
        backgroundcolor = ta.getColor(R.styleable.Title_bar_backgroundcolor, getResources().getColor(R.color.default_titlebar_bg_color));
        ta.recycle();
