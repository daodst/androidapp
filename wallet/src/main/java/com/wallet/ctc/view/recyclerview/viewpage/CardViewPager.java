...
package com.wallet.ctc.view.recyclerview.viewpage;
...
public class CardViewPager extends RecyclerView {
    ...
    private void scrollToCard(int pageOffset) {
        ...
        final int toCenter = (int) (toLeft + (getWidth() * wrapperAdapter.getItemWidth(targetPosition)) * .5f);
    ...
    private static class WrapperAdapter extends Adapter {
        ...
        public int getItemViewType(int position) {
            if (position == 0) {
                return VIEW_TYPE_PH_LEFT;
            }
            if (position == getItemCount() - 1) {
                return VIEW_TYPE_PH_RIGHT;
            }
