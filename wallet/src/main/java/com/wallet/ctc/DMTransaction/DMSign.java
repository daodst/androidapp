...
public class DMSign {
    ...
    public static DMSign.SignatureData signMessage(byte[] message, ECKeyPair keyPair) {
        return signMessage(message, keyPair, true);
    }

    public static DMSign.SignatureData signMessage(byte[] message, ECKeyPair keyPair, boolean isHashed) {
        ...
        LogUtil.d("HASH"+messageHash.toString());
        LogUtil.d("HASH16"+ DecriptUtil.byte2hex(messageHash));
        ECDSASignature sig = keyPair.sign(messageHash);
        LogUtil.d("sig"+ sig.r+"            "+sig.s+"     "+sig.toString());
        ...
        return new DMSign.SignatureData(v, r, s);
    }
    ...
    public static BigInteger signedMessageToKey(
            byte[] message, DMSign.SignatureData signatureData) throws SignatureException {
    ...
    public static class SignatureData {
        ...
        public boolean equals(Object o) {
            ...
            DMSign.SignatureData that = (DMSign.SignatureData) o;
