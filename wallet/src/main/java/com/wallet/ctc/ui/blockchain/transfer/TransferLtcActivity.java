...
public class TransferLtcActivity extends BaseActivity {
...
private TransferBean data;
    ...
    public void initUiAndListener() {
     ...
     gasCount=new BigDecimal(limitCount+"");
        ...
        walletTransctionUtil.setLtctransctionListen(new WalletTransctionUtil.LtcTransctionListen() {
            @Override
        ...
        walletTransctionUtil.getLTCestimateFee(data);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            if (TextUtils.isEmpty(toAddress) || !AnyAddress.isValid(toAddress, CoinType.LITECOIN)) {
