...
public class TransfeZecActivity extends BaseActivity {
    ...
    private String feiyongStr="0.0001";
    ...
    public void initUiAndListener() {
        ...
        walletTransctionUtil.setZectransctionListen(new WalletTransctionUtil.ZecTransctionListen() {
            @Override
        ...
        walletTransctionUtil.getZecestimateFee(data);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            if (TextUtils.isEmpty(toAddress) || !AnyAddress.isValid(toAddress, CoinType.ZCASH)) {
