...
public class TransferBchActivity extends BaseActivity {
    ...
    public void initUiAndListener() {
        ...
        walletTransctionUtil.setBchtransctionListen(new WalletTransctionUtil.BchTransctionListen() {
            @Override
        ...
        walletTransctionUtil.getBchGasFee(data);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            if (TextUtils.isEmpty(toAddress) || !AnyAddress.isValid(toAddress, CoinType.BITCOINCASH)) {
