...
public class TransferDotActivity extends BaseActivity {
    ...
    public void initUiAndListener() {
        ...
        walletTransctionUtil.setDottransctionListen(new WalletTransctionUtil.DotTransctionListen() {
            @Override
            ...
            public void showGasEstimateFee(String defGasprice) {
              if(mLoadingDialog!=null)  mLoadingDialog.dismiss();
                ...
                Log.v("fsefsfsefsf",defGasprice);
                feiyongStr=defGasprice;
                feiyong.setText(new BigDecimal(feiyongStr).divide(new BigDecimal(Math.pow(10,decimal))).toPlainString());
                if (null != data) {
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            if (TextUtils.isEmpty(toAddress) || !AnyAddress.isValid(toAddress, CoinType.POLKADOT)) {
