...
public class TransferSgbActivity extends BaseActivity {
    ...
    public void initUiAndListener() {
        ...
        walletTransctionUtil.setSgbTransctionListen(new WalletTransctionUtil.SgbTransctionListen() {
    ...
    @OnClick({R2.id.img_back, R2.id.submit, R2.id.putong, R2.id.imgqrcode, R2.id.go_adddresslist})
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.img_back) {
            finish();

        }else if (i == R.id.putong) {
