...
public class TransferSolActivity extends BaseActivity {
    ...
    public void initUiAndListener() {
        ...
        mWalletEntity = walletDBUtil.getWalletInfo();
        wallettype=mWalletEntity.getType();
        ...
        fromAddress = mWalletEntity.getAllAddress();
        ...
        walletTransctionUtil.setSoltransctionListen(new WalletTransctionUtil.SolTransctionListen() {
            @Override
    ...
    public void initData() {
        if (tokenName.toLowerCase().equals(mustCoin.toLowerCase())) {
            value = mWalletEntity.getmBalance();
        } else {
            AssertBean bean = walletDBUtil.getAssetsByAddress(mWalletEntity.getAllAddress(), tokenType,wallettype);
            if (null != bean) {
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            if (TextUtils.isEmpty(toAddress) || !AnyAddress.isValid(toAddress, CoinType.SOLANA)) {
