...
public class CommissionVM extends BaseViewModel {

    TransferControlApi controlApi = new TransferControlApi();

    
    public CommissionVM(@NonNull Application application) {
        super(application);
    }
    ...
    public void onSubmit(Context context, String policyAddress, String fromAddr, String groupId, String rate, String title, String description) {
        ...
        getVoteDuring(during -> {
            controlApi.commissionVote(context, policyAddress, fromAddr, groupId, rate, title, description, new TranslationListener() {
                @Override
