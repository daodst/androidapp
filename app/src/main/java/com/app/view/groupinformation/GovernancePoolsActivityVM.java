...
public class GovernancePoolsActivityVM extends BaseViewModel {

    public MutableLiveData<Boolean> mLiveData = new MutableLiveData<>();

    
    public GovernancePoolsActivityVM(@NonNull Application application) {
        super(application);
    }
    ...
    public void onSubmit(Context context, String policyAddress, String groupId, String outAmount, String toAddress, String description) {
        getVoteDuring(during -> {
            ...
            controlApi.groupGovernancePoolsVote(context, policyAddress, address, groupId, outAmount
                    , toAddress, context.getString(R.string.governance_pools_title), description, new TranslationListener() {
                        @Override
                        ...
                        public void onTransSuccess() {
                            ...
                            ChatStatusProvide.sendCusVoteMessage(context, groupId, "", context.getString(R.string.governance_pools_title), period);
