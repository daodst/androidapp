...
public class OrganizationAuthorizationVM extends BaseViewModel {
    public MutableLiveData<Boolean> mLiveData = new MutableLiveData<>();

    
    public OrganizationAuthorizationVM(@NonNull Application application) {
        super(application);
    }
    ...
    public void onSubmit(Context context, String policyAddress, String groupId, String endBlock, String toAddress, String description) {
        getVoteDuring(during -> {
            ...
            controlApi.groupDaoAuthorizationVote(context, policyAddress, address, groupId, endBlock
                    , toAddress, context.getString(R.string.governance_authorization_title), description, new TranslationListener() {
                        @Override
                        ...
                        public void onTransSuccess() {
                            ...
                            ChatStatusProvide.sendCusVoteMessage(context, groupId, "", context.getString(R.string.governance_authorization_title), period);
