...
public class ButtonProgressBar extends View {
    ...
    public ButtonProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ButtonProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTextSize = attributeArray.getDimensionPixelSize(R.styleable.ButtonProgressBar_pbtextSize, mTextSize);
            ...
            int type = attributeArray.getInt(R.styleable.ButtonProgressBar_pbtype, 0);
            switch (type) {
                case 0:
