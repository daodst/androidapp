...
import com.app.R;
import com.app.databinding.DialogFragmentSalaryBinding;
...
public class SalaryDialogFragment extends DialogFragment {
    ...
    private DialogFragmentSalaryBinding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DialogFragmentSalaryBinding.inflate(inflater);
    ...
    public SalaryDialogFragment setClickConsumer(Runnable pClickConsumer) {
    ...
    private void initView(View view) {
        ...
        String gasTex = gasTax + " " + BuildConfig.EVMOS_FAKE_UNINT + "<font color='#0BBD8B'>" + getString(R.string.anim_device_reward_string_1) + "</font>";
        mBinding.tvGasTax.setText(Html.fromHtml(gasTex, Html.FROM_HTML_OPTION_USE_CSS_COLORS));

        String receiverDescSrt = getString(R.string.anim_salary_reward_string_1, "<br>");
    ...
    private void animatorStep2() {
        startApngAnimation(mBinding.ivSalary);
    ...
    private void animatorShowWalletInfo() {
        ...
        ObjectAnimator translationSalary = ObjectAnimator.ofFloat(mBinding.ivSalary, "translationX", width);
        ...
        animatorSet2.play(translationReceiver).with(alphaReceiver).with(translationReceiverTitle).with(alphaReceiverTitle)
                
                .with(transYWalletDetail);

        AnimatorSet animatorSet3 = getAnimatorSet();
        animatorSet3.setDuration(500L);
        
        animatorSet3.play(translationSalary);
    ...
    private void startApngAnimation(ImageView view) {
        AssetStreamLoader assetLoader = new AssetStreamLoader(mContext, "gongzi.png");
