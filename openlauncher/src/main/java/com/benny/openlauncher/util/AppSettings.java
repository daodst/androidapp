...
public class AppSettings extends SharedPreferencesPropertyBackend {
    ...
    public static AppSettings get() {
        return new AppSettings(AppObject.get().getApplicationContext());
    }
    ...
    public int getDesktopRowCount() {
        return getInt(R.string.pref_key__desktop_rows, 7);
    }
    ...
    public int getDockColumnCount() {
        return getInt(R.string.pref_key__dock_columns, 3);
    }
    ...
    public boolean getGestureFeedback() {
        return getBool(R.string.pref_key__gesture_feedback, true);
    }
