    ...
    private class AsyncGetApps extends AsyncTask {
        ...
        protected Object doInBackground(Object[] p1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                String appId = _context.getPackageName();
                nonFilteredAppsTemp.removeIf(app -> app._packageName.equals(appId));
            }else {
                Iterator<App> iterator = nonFilteredAppsTemp.iterator();
                while (iterator.hasNext()) {
                    String appId = _context.getPackageName();
                    if (appId.equalsIgnoreCase(iterator.next()._packageName)) {
                        iterator.remove();
                    }
                }
            }
        ...
        protected void onPostExecute(Object result) {
            ...
            }else notifyUpdateListeners(appsTemp);
