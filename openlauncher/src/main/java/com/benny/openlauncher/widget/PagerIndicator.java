...
public final class PagerIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    private Paint _paint2 = new Paint(1);
    ...
    private float _expandFactor = 1.2f;
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        _paint.setStrokeWidth(Tool.dp2px(2));
        _paint.setAntiAlias(true);

        _paint2.setColor(0x66FFFFFF);
        _paint2.setStrokeWidth(Tool.dp2px(2));
        _paint2.setAntiAlias(true);
    }

    @Override
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        _dotSize = getHeight() / 4;
            ...
            case Mode.DOTS:
                ...
                for (int dot = 0; dot < pageCount; dot++) {
                    ...
                    if (dot == _pager.getCurrentItem()) {
                        ...
                        canvas.drawCircle(_dotSize / 2 + _pad + (_dotSize + _pad * 2) * dot, (float) (getHeight() / 2), _expandFactor * _dotSize / 2, _paint2);
                        ...
                        canvas.drawCircle(_dotSize / 2 + _pad + (_dotSize + _pad * 2) * dot, (float) (getHeight() / 2), _dotSize / 2, _paint2);
                    }
                }
                break;
            case Mode.LINES:
