...
public class CellContainer extends ViewGroup implements MyViewGroup {
    ...
    private boolean subtractBottomHeight = true;
    ...
    public final void setGridSize(int x, int y, boolean subtractBottomHeight) {
        _cellSpanV = y;
        _cellSpanH = x;
        this.subtractBottomHeight = subtractBottomHeight;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (subtractBottomHeight) {
            height = ((b - t) - getPaddingTop()) - getPaddingBottom() - bottomHeight();
        }
        if (_cellSpanH == 0) {
            _cellSpanH = 1;
        }
