...
class RoomProfileActivity :
    ...
    companion object {
        ...
        const val EXTRA_DIRECT_ACCESS_ROOM_MEMBERS_DAILY = 3
    ...
    override fun initUiAndData() {
        ...
        if (isFirstCreation()) {
            when (intent?.extras?.getInt(EXTRA_DIRECT_ACCESS, EXTRA_DIRECT_ACCESS_ROOM_ROOT)) {
                ...
                EXTRA_DIRECT_ACCESS_ROOM_MEMBERS_DAILY -> {
                    
                    addFragment(views.simpleFragmentContainer, RoomMemberDailyListFragment::class.java, roomProfileArgs)
                }
