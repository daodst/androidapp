...
class PillImageSpan(private val glideRequests: GlideRequests,
    ...
    private fun createChipDrawable(): ChipDrawable {
        ...
        return ChipDrawable.createFromResource(context, R.xml.pill_view).apply {
            ...
            chipIcon = icon
            Timber.i("----PillImageSpan----------------${matrixItem}-------------------------------")
            ...
            if (matrixItem is MatrixItem.UserItem ) {
                ...
                chipBackgroundColor = ColorStateList.valueOf(ContextCompat.getColor(context, R.color.color_group_pill))
                
                setTextAppearanceResource(R.style.TextAppearance_Vector_Body_Group)
            }
