...
import im.vector.app.databinding.FragmentCreateAnimDialogBinding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import me.fenfei.anim.enter.en.dp2px

class CreateAnimFragmentDialog : DialogFragment() {



    lateinit var animDrawable: AnimationDrawable

    lateinit var views: FragmentCreateAnimDialogBinding
    ...
    override fun onCreateView(
        ...
        views = FragmentCreateAnimDialogBinding.inflate(inflater, container, false)
        return views.root
    }
    ...
    private fun doAnim(callback: Drawable.Callback) {
        lifecycleScope.launch {
            ...
            doAnim(views.createAnimTips3, dp2px(40f), 200, 67 + 67)
            doAnim(views.createAnimBottom, dp2px(40f), 200, 67 + 67 + 67)
            doAnim(views.createAnimBt, 0f, 200, 200 + 67 + 67 + 67)
        }
    ...
    private fun reset() {
        ...
        views.createAnimTips3.alpha = 0f
