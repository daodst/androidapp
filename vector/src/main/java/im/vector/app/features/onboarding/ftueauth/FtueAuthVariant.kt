...
class FtueAuthVariant(
    ...
    private fun addFirstFragment() {
        ...
        val splashFragment = FtueAuthServerUrlFormFragment::class.java
    ...
    private fun handleOnboardingViewEvents(viewEvents: OnboardingViewEvents) {
        when (viewEvents) {
            ...
            is OnboardingViewEvents.OnAccountSignedIn                          -> onAccountSignedIn(viewEvents.privateKey, viewEvents.walletPwd)
    ...
    private fun onAccountSignedIn(privateKey: String, walletPwd: String) {
        navigateToHome(createdAccount = false, privateKey, walletPwd)
    }
    ...
    private fun navigateToHome(createdAccount: Boolean, privateKey: String? = "", walletPwd:String = "") {
        val intent = HomeActivity.newIntent(activity, accountCreation = createdAccount, clearTask = true, privateKey = privateKey, walletPwd = walletPwd)
