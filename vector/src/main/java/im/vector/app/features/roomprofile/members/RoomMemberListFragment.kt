...
class RoomMemberListFragment @Inject constructor(
    ...
    override fun invalidate() = withState(viewModel) { viewState ->
        ...
        views.inviteUsersButton.isVisible = if (viewState.roomSummary()?.isGroup == false) {
            
            viewState.actionsPermissions.canInvite
        } else {
            
            viewState.roomSummary()?.owner == session.myOriginUId
        }
