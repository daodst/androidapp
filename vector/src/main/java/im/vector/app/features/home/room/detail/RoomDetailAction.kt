...
sealed class RoomDetailAction : VectorViewModelAction {
    data class EditCusAwardMessage(
            val targetEvent: TimelineEvent,
            val type: String,
            val status: Int,
            val balance: String?,
    ) : RoomDetailAction()
    ...
    data class ReSendMedia(val event: TimelineEvent) : RoomDetailAction()
    data class SendCusText(val content: String) : RoomDetailAction()
    data class DelAtMsg(val id: Long) : RoomDetailAction()
    object DelAllAtMsg : RoomDetailAction()
    data class SendRedPacket(val redPacketId: String?, val transferNum: String, val symbol: String) : RoomDetailAction()
    ...
    data class CheckCallUserInfoStatus(val vedio: Boolean, val refersh: Boolean) : RoomDetailAction()
    ...
    data class SearchResultListener(val eventId: String) : RoomDetailAction()
}
