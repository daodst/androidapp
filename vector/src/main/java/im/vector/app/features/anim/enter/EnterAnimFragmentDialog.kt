...
import im.vector.app.databinding.FragmentEnterAnimDialogBinding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import me.fenfei.anim.enter.en.dp2px

class EnterAnimFragmentDialog : DialogFragment() {

    lateinit var animDrawable: AnimationDrawable

    lateinit var views: FragmentEnterAnimDialogBinding
    ...
    override fun onCreateView(
        ...
        views = FragmentEnterAnimDialogBinding.inflate(inflater, container, false)
        return views.root
    }
