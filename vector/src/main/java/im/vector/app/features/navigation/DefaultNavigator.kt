...
class DefaultNavigator @Inject constructor(
    ...
    override fun softLogout(context: Context) {
        ...
        (context as? FragmentActivity)?.let {
            SignOutUiWorker(it).forceSignOut();
        }
    }
    ...
    override fun openRoom(
        ...
        val args = TimelineArgs(roomId = roomId, eventId = eventId, isInviteAlreadyAccepted = isInviteAlreadyAccepted, displayMode = displayMode)
    ...
    override fun openRoomMemberProfile(userId: String, roomId: String?, context: Context, buildTask: Boolean, displayMode: RoomListDisplayMode) {
        val args = RoomMemberProfileArgs(userId = userId, roomId = roomId, displayMode = displayMode)
    ...
    override fun openSearch(context: Context,
        ...
        val intent = SearchActivity.newIntent(context, SearchArgs(roomId,eventId, rootThreadEventId,roomDisplayName, roomAvatarUrl))
        context.startActivity(intent)
    }

      override fun openSearchForResult(context: Context,
                            roomId: String,
                            eventId: String?,
                            rootThreadEventId: String?,
                            roomDisplayName: String?,
    ...
    override fun openSendRedpacket(context: Context, roomId: String) {
