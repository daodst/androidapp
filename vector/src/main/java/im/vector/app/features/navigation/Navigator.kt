...
interface Navigator {
    ...
    fun openRoom(context: Context, roomId: String, eventId: String? = null, buildTask: Boolean = false, isInviteAlreadyAccepted: Boolean = false,  displayMode: RoomListDisplayMode = RoomListDisplayMode.FILTERED)
    ...
    fun openRoomMemberProfile(userId: String, roomId: String?, context: Context, buildTask: Boolean = false,   displayMode: RoomListDisplayMode = RoomListDisplayMode.FILTERED)
    ...
    fun openSendRedpacket(context: Context, roomId: String)
