...
class HomeActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isFirstCreation()) {
            replaceFragment(views.homeDetailFragmentContainer, HomeActivityFragment::class.java)
        ...
        sharedActionViewModel
                ...
                .onEach { sharedAction ->
                    when (sharedAction) {
                        ...
                        is HomeActivitySharedAction.CloseDrawer       -> {
                        }
                        is HomeActivitySharedAction.OpenGroup         -> {
                            ...
                            if (sharedAction.clearFragment) {
                                replaceFragment(views.homeDetailFragmentContainer, HomeActivityFragment::class.java, allowStateLoss = true)
                            } else {
