...
import im.vector.app.features.createdirect.migrate.MigrateGroupViewModel
...
import im.vector.app.features.home.BootstrapViewModel
import im.vector.app.features.home.CopySignoutCheckViewModel
import im.vector.app.features.home.HomeActivityViewModel
import im.vector.app.features.home.HomeDetailViewModel
import im.vector.app.features.home.SharedSecureMainStorageViewModel
import im.vector.app.features.home.UnknownDeviceDetectorSharedViewModel
import im.vector.app.features.home.UnreadMessagesSharedViewModel
import im.vector.app.features.home.UserColorAccountDataViewModel
import im.vector.app.features.home.VerificationBottomSheetMainViewModel
...
import im.vector.app.features.me.VectorMeViewModel
import im.vector.app.features.media.VectorAttachmentViewerViewModel
import im.vector.app.features.onboarding.OnboardingViewModel
import im.vector.app.features.pay4invite.Pay4InviteViewModel
...
import im.vector.app.features.roomprofile.daily.RoomMemberDailyListViewModel
...
interface MavericksViewModelModule {
    ...
    @Binds
    @IntoMap
    @MavericksViewModelKey(RoomMemberDailyListViewModel::class)
    fun roomMemberDailyListViewModelFactory(factory: RoomMemberDailyListViewModel.Factory): MavericksAssistedViewModelFactory<*, *>
    ...
    @Binds
    @IntoMap
    @MavericksViewModelKey(VectorMeViewModel::class)
    fun vectorMeViewModelFactory(factory: VectorMeViewModel.Factory): MavericksAssistedViewModelFactory<*, *>

    @Binds
    @IntoMap
    @MavericksViewModelKey(Pay4InviteViewModel::class)
    fun pay4InviteViewModel(factory: Pay4InviteViewModel.Factory): MavericksAssistedViewModelFactory<*, *>
    ...
    @Binds
    @IntoMap
    @MavericksViewModelKey(ClusterViewModel::class)
    fun clusterFactory(factory: ClusterViewModel.Factory): MavericksAssistedViewModelFactory<*, *>

    @Binds
    @IntoMap
    @MavericksViewModelKey(MigrateGroupViewModel::class)
    fun migrateGroupFactory(factory: MigrateGroupViewModel.Factory): MavericksAssistedViewModelFactory<*, *>
    ...
    @Binds
    @IntoMap
    @MavericksViewModelKey(BootstrapViewModel::class)
    fun bootstrapViewModelFactory(factory: BootstrapViewModel.Factory): MavericksAssistedViewModelFactory<*, *>

    @Binds
    @IntoMap
    @MavericksViewModelKey(CopySignoutCheckViewModel::class)
    fun CopySignoutCheckViewModelFactory(factory: CopySignoutCheckViewModel.Factory): MavericksAssistedViewModelFactory<*, *>

    @Binds
    @IntoMap
    @MavericksViewModelKey(SharedSecureMainStorageViewModel::class)
    fun sharedSecureMainStorageViewModelFactory(factory: SharedSecureMainStorageViewModel.Factory): MavericksAssistedViewModelFactory<*, *>

    @Binds
    @IntoMap
    @MavericksViewModelKey(VerificationBottomSheetMainViewModel::class)
    fun verificationBottomSheetViewMainStateModelFactory(factory: VerificationBottomSheetMainViewModel.Factory): MavericksAssistedViewModelFactory<*, *>
