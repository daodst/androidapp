            ...
            is Failure.ServerError                 -> {
                when {
                    ...
                    throwable.error.code == MatrixError.M_BAD_JSON                     -> {
                        stringProvider.getString(R.string.login_error_bad_json)+":"+throwable.error.message
                    }
                    ...
                    throwable.error.code == MatrixError.M_UNKNOWN &&
                        ...
                        val msg = "error_" + throwable.error.message.lowercase()
                                .replace("'", "")
                                .replace("%", "")
                                .replace(";", "")
                                .replace("(", "")
                                ...
                                .replace("-", "")
                                .replace(" ", "_")
                        val id: Int = stringProvider.resources.getIdentifier(msg, "string", context.getPackageName())
                        if (0 != id) {
