...
import im.vector.app.features.createdirect.migrate.MigrateGroupFragment
...
import im.vector.app.features.pay4invite.Pay4InviteFragment
...
import im.vector.app.features.roomprofile.daily.RoomMemberDailyListFragment
...
interface FragmentModule {
    ...
    @Binds
    @IntoMap
    @FragmentKey(ClusterCreateFragment::class)
    fun bindClusterCreateFragment(fragment: ClusterCreateFragment): Fragment


    @Binds
    @IntoMap
    @FragmentKey(MigrateGroupFragment::class)
    fun bindMigrateGroupFragment(fragment: MigrateGroupFragment): Fragment



    @Binds
    @IntoMap
    @FragmentKey(ClusterUpgradeFragment::class)
    fun bindClusterUpgradeFragment(fragment: ClusterUpgradeFragment): Fragment
    ...
    @Binds
    @IntoMap
    @FragmentKey(RoomMemberDailyListFragment::class)
    fun bindRoomMemberDailyListFragment(fragment: RoomMemberDailyListFragment): Fragment
    ...
    @Binds
    @IntoMap
    @FragmentKey(CusRoomMemberProfileFragment::class)
    fun bindCusRoomMemberProfileFragment(fragment: CusRoomMemberProfileFragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(Pay4InviteFragment::class)
    fun bindPay4InviteFragment(fragment: Pay4InviteFragment): Fragment
