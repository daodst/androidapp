package im.vector.app.easyfloatcall.floatingview;
...
import im.vector.app.easyfloatcall.floatingview.utils.EnContext;
...
public class FloatingView implements IFloatingView {
    ...
    @DrawableRes
    private int mIconRes = R.drawable.homepae;
