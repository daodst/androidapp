...
public class WebviewSettingProxy {
    ...
    public static boolean setProxy(WebView webview, String host, String port, String applicationClassName) {
    ...
    private static boolean setProxyICS(WebView webview, String host, String port) {
        try {
    ...
    @SuppressWarnings("all")
    private static boolean setProxyJB(WebView webview, String host, String port) {
    ...
    @SuppressLint("NewApi")
    @SuppressWarnings("all")
    private static boolean setProxyKKPlus(WebView webView, String host, String port, String applicationClassName) {
