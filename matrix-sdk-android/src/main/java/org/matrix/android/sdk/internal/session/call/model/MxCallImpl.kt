...
internal class MxCallImpl(
    ...
    override fun offerSdp(sdpString: String) {
        ...
        Timber.tag(loggerTag.value).v("offerSdp $callId,   userId $userId")
        state = CallState.Dialing
        val addressByUid = getAddressByUid(userId);
        val phone = MMKV.defaultMMKV()?.getString(addressByUid + MXCALL_KEY_PHONE, "") ?: ""
