...
import org.matrix.android.sdk.api.session.utils.UtilsModule
...
import org.matrix.android.sdk.internal.session.tts.TtsModule
...
internal interface SessionComponent {
    ...
    fun inject(worker: TranslateBeforeUploadWorker)
