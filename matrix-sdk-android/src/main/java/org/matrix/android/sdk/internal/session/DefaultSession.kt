...
internal class DefaultSession @Inject constructor(
        ...
        private val utilsService: Lazy<UtilsService>,
        private val errorHandler: Lazy<GlobalErrorInteract>,
        private val userService: Lazy<UserService>,
        private val ttsService: Lazy<TtsService>,
        private val chatPhoneLogService: Lazy<ChatPhoneLogService>,
        ...
        private val remarkManager: Lazy<RemarkManager>,
        private val chainUploadService: Lazy<ChainUploadService>,
        @UnauthenticatedWithCertificate
        private val unauthenticatedWithCertificateOkHttpClient: Lazy<OkHttpClient>
) : Session,
        GlobalErrorHandler.Listener,
        RoomService by roomService.get(),
        GlobalErrorInteract by errorHandler.get(),
        UtilsService by utilsService.get(),
        RoomDirectoryService by roomDirectoryService.get(),
        GroupService by groupService.get(),
        UserService by userService.get(),
        TtsService by ttsService.get(),
        ChatPhoneLogService by chatPhoneLogService.get(),
        ...
        RemarkManager by remarkManager.get(),
        ChainUploadService by chainUploadService.get(){
    ...
    override fun contentDownloadProgressTracker(): ContentDownloadStateTracker =
