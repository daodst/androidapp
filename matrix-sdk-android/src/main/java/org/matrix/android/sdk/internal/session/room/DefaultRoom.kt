...
internal class DefaultRoom(
    ...
    override fun delAtMsg(eventId: String) {
        roomSummaryDataSource.delAtMsg(roomId, eventId)
    }

    override fun clearAtMsg() {
        roomSummaryDataSource.clearAtMsg(roomId)
    }
    ...
    override fun setRoomSummaryGroupStatus(isGroup: Boolean) {
        roomSummaryDataSource.setRoomSummaryGroupStatus(roomId, isGroup)
    }

    override fun setRoomSummaryOwner(owner: String) {
        roomSummaryDataSource.setRoomSummaryOwner(roomId, owner)
    }

    override fun setRoomSummaryDvmStatus(isDvmGroup: Boolean) {
        roomSummaryDataSource.setRoomSummaryDvmStatus(roomId, isDvmGroup)
    }

    override fun setRoomSummaryLevel(level: Int) {
        roomSummaryDataSource.setRoomSummaryLevel(roomId, level)
    }

    override fun setRoomSummaryUpgradeAnimShow(show: Boolean) {
        roomSummaryDataSource.setRoomSummaryUpgradeAnimShow(roomId, show)
    }
