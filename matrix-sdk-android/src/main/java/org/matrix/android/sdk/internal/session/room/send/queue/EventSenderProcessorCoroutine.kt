...
internal class EventSenderProcessorCoroutine @Inject constructor(
        ...
        private val interact: GlobalErrorInteractImpl
        ...
        try {
            ...
            when {
                ...
                exception is CancellationException                                 -> {
                    ...
                    Timber.v("##   ${exception}  ## un-retryable error for $task, try next task")

                    interact.getGlobalErrorInteractHandler().forEach {
                        it.handlerThrowable(exception, task.queueIdentifier)
                    }
