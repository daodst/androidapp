...
import org.matrix.android.sdk.internal.session.room.membership.DefaultLoadRoomAllMembersTask
import org.matrix.android.sdk.internal.session.room.membership.DefaultLoadRoomMembersTask
import org.matrix.android.sdk.internal.session.room.membership.LoadRoomAllMembersTask
...
internal abstract class RoomModule {
    ...
    @Binds
    abstract fun bindLoadAllRoomMembersTask(task: DefaultLoadRoomAllMembersTask): LoadRoomAllMembersTask
