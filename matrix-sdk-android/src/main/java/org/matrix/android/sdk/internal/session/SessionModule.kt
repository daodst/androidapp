...
import org.matrix.android.sdk.internal.session.chain.DefaultChainUpload
...
import org.matrix.android.sdk.internal.session.remark.DefaultRemarkManager
...
internal abstract class SessionModule {
    ...
    @Binds
    abstract fun bindGlobalErrorInteract(handler: GlobalErrorInteractImpl): GlobalErrorInteract
    ...
    @Binds
    abstract fun bindRemarkManager(remarkManager: DefaultRemarkManager): RemarkManager

    @Binds
    abstract fun bindChainUploadService(chainUpload: DefaultChainUpload): ChainUploadService
}
